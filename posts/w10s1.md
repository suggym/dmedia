...
*The role of the camera in this project was to be a POV of the player, a controllable agent with which to navigate the space. Similarly, the camera was also used as a first-person POV for the protagonist; 'me'. However, the viewer has absolutely no agency over the actions of the 'player' in my video game based video, and must watch as the events unfold. But despite the notion of agency being established by the controllable POV camera in the unity game, ultimately the design of the game encourages the player to specific ending, not unlike my video, whereby the subtle nagivational clues ultimately forces them into the cabin, concluding the game as intended.*
...
*Both 'non-diegetic' and 'diegetic' sound are use to create not only atmosphere but also context throughout the enviroment, the diegetic bird and insect ambience illustrating the forest setting, whilst the slow tempo peaceful guitar, or contrastingly the loud orchestral piece with an accelerating heartbeat gave emotional context to each part of the environment. In both my video self portrait and this digital environment the sound and visuals work symbiotically to provided emotional and physical context, the 'video-game' SFX working similarly to the sound coming from the virus and the bird and insect ambience. However, in assignment two the SFX work differently. Although the icon SFX provide thematic context like in AS1 and 3, they are more interactive and statically 'placed' within the design.* 
...
*The natural terrain assets were specifically curated using reference photos to resemble a park in my hometown, as well as adjusted lighting aspects of each asset to ensure the were cohesive. At first there were going to be animals, water and other aspects to distract the player and illustrate the fleeting beauty of nature, however after an inane struggle to find these assets I ultimately decided to try and make the terrain as accurate as possible to the aforementioned park, which I appreciated for its simplistic beauty after we were finally let out of lockdown.*

- What did you discover through the process of play testing that you wouldn’t have
discovered otherwise? 

*Without the path my friend Jackson struggled to find the house due to the blockage by the trees and I did have to mention there was more to the game. After the playtest I added not only the 3D path to the house, but also figured out how to remove the trees. I also some eery music attached to the virus to add an extra layer of creepy as it was coming across as too comedic in the playtest. I also added a fade to black end card once a player has tried to escape to signify the end as Jackson was curious if it was over or not and was confused if there was more or not.*
...
Maybe too modern/instagram-trendy????? Not really my style. Too 'graphic design major' for me. I do LOVE the bright colours in number 1 but not sure how to incorporate the photos and screenshots that do not match that theme.

## Artist Statement
Each statement I want to be written casually, personally and be fun to read, but still professional in a teacher kind of way.

## Assignment 1 - Video Self Portrait
When tasked by my lecturer to make a iPhone ‘video self-portrait’ with no SFX, no time interpolation, NOTHING, I had absolutely no idea what to do. What about myself do I express in my first ever uni assignment? How was I gonna do it with no help from my comfort software- premiere pro? 

However, working with no FX (not so surprisingly) taught me a lot about visual story telling. Without flashy graphics, the short video depicts my moving to Melbourne process through the eyes of a retro video game, each object I bring with me an not only an interactive game asset, but also a symbol of who I am and what I choose to make my space feel like ‘home’. In what I like to call ‘the chaos sequence’, I needed to express the terrible anxiety amongst moving in, the representations of myself almost mocking me in this sequence, my experience with o-week insomnia as the slightly comedic climax. This video is obviously not my greatest technical achievement given the restrictions, but it is my greatest storytelling one, depicting me and what I stand for without words or over-doing it in premiere.

## Assignment 2 - Icon design
Above, is the link to my flat design icon project entitled ‘Is This a Gun?’. I was inspired heavily by Cara Levine’s “This is Not a Gun”, a collection of ceramic common items that have been mistakenly seen as a gun by police, and has resulted in an innocent person’s death. Despite being thematically much more serious than most of my work, this is one of the pieces I am proudest of, and exemplifies the impact I would like all my pieces to one day have . Taking nine of the objects from Levine’s collection and converting them to flat design in Illustrator, each icon represents a person who died at the hands of police. 

A twisted shopping list, when one hovers their mouse over each icon produces a different gunshot, or police radio chatter, that bit by bit gives context as to why the icons are suddenly, covered in blood. This piece was created highlight how these seemingly innocuous items can lead to tragic outcomes in a systemically brutalised and overfunded policing system.   


## Assignment 3 - 3D
Lockdown sucked, as many will agree, and this digital environment pretty much sums up that transition, a time of fear and monotony. Inspired by those Roblox horror games that were wildly popular in 2020, this environment is a short journey, criticising the lack of appreciation that I had for the beauty of the world around me before ‘isolation’. 

I mustn’t spoil the ending, but I will say I have put a lot of thought into the intention behind each element of this Unity project. I wanted this digital environment to be more than just a visual representation, a emotional and psychological exploration of what isolation during COVID-19 felt like and the transformation between what we considered normal, to our new reality.
